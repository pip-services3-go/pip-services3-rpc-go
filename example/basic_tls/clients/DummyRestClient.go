...
var (
	dummyDataPageType = reflect.TypeOf(&edata.DummyDataPage{})
	dummyType         = reflect.TypeOf(&edata.Dummy{})
)
...
func (c *DummyRestClient) GetDummies(correlationId string, filter *cdata.FilterParams,
	paging *cdata.PagingParams) (result *edata.DummyDataPage, err error) {
	...
	result, _ = calValue.(*edata.DummyDataPage)
	c.Instrument(correlationId, "dummy.get_page_by_filter")
	return result, nil
}

func (c *DummyRestClient) GetDummyById(correlationId string, dummyId string) (result *edata.Dummy, err error) {
	...
	result, _ = calValue.(*edata.Dummy)
	c.Instrument(correlationId, "dummy.get_one_by_id")
	return result, nil
}

func (c *DummyRestClient) CreateDummy(correlationId string, dummy edata.Dummy) (result *edata.Dummy, err error) {
...
func (c *DummyRestClient) UpdateDummy(correlationId string, dummy edata.Dummy) (result *edata.Dummy, err error) {
...
func (c *DummyRestClient) DeleteDummy(correlationId string, dummyId string) (result *edata.Dummy, err error) {
